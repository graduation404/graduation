                        ...
                        renderItem={({ item, index }) => (
                            <>
                                <LevelContainer
                                    ...
                                    style={{ borderWidth: LevelIndex == index ? RFPercentage(0.3) : RFPercentage(0), borderColor: LevelIndex == index ? COLORS.blue : null, }}
                        ...
                        renderItem={({ item, index }) => (
                            <>
                                <BookletContainer
                                    ...
                                    style={{ borderWidth: BookletIndex == index ? RFPercentage(0.3) : RFPercentage(0), borderColor: BookletIndex == index ? COLORS.blue : null, }}
                                    Text={item.Text} Image={item.Image} Persentage={item.Persentage} />
                            </>
                        )
                        }
